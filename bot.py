...
def main_menu(chat_id):
    ...
    bot.send_message(
        chat_id,
        "Ваши первые шаги на пути к новой жизни, без страхов, стеснения, эмоционального и физического напряжения, благодаря свободному танцу от хореографа проекта «Танцы на ТНТ» известного танцовщика Александра Могилёва. Смотрите видео ⬇️",
        reply_markup=markup
    )
...
def send_followup_links(chat_id):
    ...
    bot.send_message(chat_id, "Мы поможем Вам раскрыться! Танец — это Ваш способ вернуть энергию, избавиться от стресса и стать уверенней в себе. Приходите на пробное занятие «ЭТО ЛЮДИ» всего за 499 и начните двигаться свободно в дружелюбной и непринуждённой атмосфере. Жмите кнопку — сделайте первый шаг к новой жизни уже сегодня! ⬇️", reply_markup=markup)
